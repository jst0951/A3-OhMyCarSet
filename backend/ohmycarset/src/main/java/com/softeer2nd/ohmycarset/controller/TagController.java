...
public class TagController {
    ...
    @Cacheable(value = "keywordTagRequiredOption", key = "{#optionName, #userInfoDto.age, #userInfoDto.gender, #userInfoDto.tag1, #userInfoDto.tag2, #userInfoDto.tag3}")
    ...
    @Cacheable(value = "keywordTagOptionPackage", key = "{#packageName, #userInfoDto.age, #userInfoDto.gender, #userInfoDto.tag1, #userInfoDto.tag2, #userInfoDto.tag3}")
